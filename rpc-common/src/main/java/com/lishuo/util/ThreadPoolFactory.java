...
public class ThreadPoolFactory {
    ...
    private final static Logger logger =
            LoggerFactory.getLogger(ThreadPoolFactory.class);

    private static Map<String, ExecutorService> threadPollsMap =
    ...
    public static ExecutorService createDefaultThreadPool(String threadNamePrefix,
        ...
        ExecutorService pool =
                threadPollsMap.computeIfAbsent(threadNamePrefix,
    ...
    private static ExecutorService createThreadPool(String threadNamePrefix, Boolean daemon) {
        ...
        return new
                ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE_SIZE,
        ...
        if (threadNamePrefix != null) {
            if (daemon != null) {
                return new ThreadFactoryBuilder()
                        .setNameFormat(threadNamePrefix + "-%d").setDaemon(daemon).build();
            } else {
                return new ThreadFactoryBuilder()
